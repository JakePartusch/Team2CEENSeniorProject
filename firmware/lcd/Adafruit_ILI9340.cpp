...
#define SETBITS(port,pin) ((port) |= (pin)) 
...
void Adafruit_ILI9340::drawFastVLine(int16_t x, int16_t y, int16_t h, uint16_t color) 
{
...
// fill a rectangle
void Adafruit_ILI9340::fillRect(int16_t x, int16_t y, int16_t w, int16_t h, uint16_t color) 
{
